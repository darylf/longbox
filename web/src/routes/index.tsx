...
import ListPublishers from "./list-publishers";
...
import ViewPublisher from "./view-publisher";
...
export const AppRoutes = () => {
  ...
  const commonRoutes = [
    ...
    { path: "/publishers/:id", element: <ViewPublisher /> },
    { path: "/publishers", element: <ListPublishers /> },
